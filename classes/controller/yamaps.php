...
/**
 * Ymaps module demo controller. This controller should NOT be used in production.
...
class Controller_Yamaps extends Controller {
	...
	{
		// Create a new Ymap
		$map = new Yamaps('map', array
		(
			'ScrollWheelZoom' => TRUE,
		));

		// Set the map center point
		$map->center(37.64, 55.76, 10);
			//->controls('large')
			//->types('G_PHYSICAL_MAP', 'add');
...
//		$map->add_marker(44.9801, -93.2519, '<strong>Minneapolis, MN</strong><p>Hello world!</p>', array('icon' => 'tinyIcon', 'draggable' => true, 'bouncy' => true));
		...
		$this->request->response = View::factory('yamaps/api_demo')
			->set('api_url', Yamaps::api_url())
			->set('map', $map->render());
	}
